  ...
  return (
    <div className="flex h-screen justify-center items-center relative">
      ...
      <div className="relative z-10 flex flex-col md:flex-row h-auto md:h-[90vh] w-[90vw] max-w-6xl bg-white rounded-lg overflow-hidden shadow-lg">
        ...
        {/* Right Section (Form and Social Sign-Up Buttons for Small Screens) */}
        <div className="w-full md:w-3/5 flex flex-col justify-center p-8 md:p-16 bg-gray-50 relative">
          
          {/* Social Media Buttons for Small Screens */}
          <div className="md:hidden mb-8 text-center">
            <h3 className="text-gray-700 text-lg font-semibold mb-4">Sign up with</h3>
            <div className="flex space-x-4 justify-center">
              <button aria-label="Sign up with Google" className="p-2 rounded-full shadow-lg hover:shadow-xl transition">
                <img src={googleIcon} alt="Google" className="w-8 h-8" />
              </button>
          ...
          <h2 className="text-3xl font-bold mb-8 text-center md:text-left">Sign up</h2>
          ...
          {/* Sign-Up Button */}
          <div className="mt-7">
            <button className="bg-gray-400 w-full md:w-40 text-white py-2 px-4 rounded-full">
              Sign up
            </button>
          </div>
